...
*  NAME
*
*  compass_time - determine current universal time
*
*  SYNOPSIS
*
...
*  RETURNS
*
*  The routine compass_time returns the current universal time (UTC), in
...
*  NAME
*
*  compass_difftime - compute difference between two time values
*
*  SYNOPSIS
*
...
*  RETURNS
*
*  The routine compass_difftime returns the difference between two time
