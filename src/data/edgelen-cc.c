...
/*    EXPORTED FUNCTIONS:                                                   */
/*                                                                          */
/*  int CCutil_dat_setnorm (compass_data *dat, int norm)                     */
/*     NOTES:                                                               */
...
/*         and you have more than one compass_data, you must call            */
/*         CCutil_dat_setnorm whenever you switch from using one            */
/*         compass_data to the other.  IF YOU DON'T DO THIS, EDGELEN WILL    */
...
/*        userdat field of the compass_data argument (userdat is of type     */
/*        CCdata_user).                                                     */
...
/*                                                                          */
/*  void CCutil_dsjrand_init (compass_data *dat, int maxdist, int seed)      */
/*     initialize the dsjrand norm                                          */
/*                                                                          */
/*  void CCutil_dat_getnorm (compass_data *dat, int *norm)                   */
/*     get the norm of a compass_data                                        */
/*                                                                          */
/*  void CCutil_init_datagroup (compass_data *dat)                           */
/*     initialize a compass_data                                             */
/*                                                                          */
/*  void CCutil_freedatagroup (compass_data *dat)                            */
/*     free a compass_data                                                   */
/*                                                                          */
/****************************************************************************/
...
static int
    edgelen_nonorm (int i, int j, compass_data *dat),
    max_edgelen (int i, int j, compass_data *dat),
    man_edgelen (int i, int j, compass_data *dat),
    euclid_edgelen (int i, int j, compass_data *dat),
    euclid_ceiling_edgelen (int i, int j, compass_data *dat),
    euclid3d_edgelen (int i, int j, compass_data *dat),
    geographic_edgelen (int i, int j, compass_data *dat),
    geom_edgelen (int i, int j, compass_data *dat),
    att_edgelen (int i, int j, compass_data *dat),
    dsjrand_edgelen (int i, int j, compass_data *dat),
    crystal_edgelen (int i, int j, compass_data *dat),
    matrix_edgelen (int i, int j, compass_data *dat),
    sparse_edgelen (int i, int j, compass_data *dat),
    user_edgelen (int i, int j, compass_data *dat),
    rhmap1_edgelen (int i, int j, compass_data *dat),
    rhmap2_edgelen (int i, int j, compass_data *dat),
    rhmap3_edgelen (int i, int j, compass_data *dat),
    rhmap4_edgelen (int i, int j, compass_data *dat),
    rhmap5_edgelen (int i, int j, compass_data *dat),
    toroidal_edgelen (int i, int j, compass_data *dat);
...
int (*CCutil_dat_edgelen) (int i, int j, compass_data *dat) = edgelen_nonorm;
...
static int max_edgelen (int i, int j, compass_data *dat)
{
...
static int man_edgelen (int i, int j, compass_data *dat)
{
    double t1 = dat->x[i] - dat->x[j], t2 = dat->y[i] - dat->y[j];
...
static int euclid_edgelen (int i, int j, compass_data *dat)
{
    double t1 = dat->x[i] - dat->x[j], t2 = dat->y[i] - dat->y[j];
    int temp;
...
static int toroidal_edgelen (int i, int j, compass_data *dat)
{
...
static int euclid3d_edgelen (int i, int j, compass_data *dat)
{
    double t1 = dat->x[i] - dat->x[j], t2 = dat->y[i] - dat->y[j];
...
static int euclid_ceiling_edgelen (int i, int j, compass_data *dat)
{
    double t1 = dat->x[i] - dat->x[j], t2 = dat->y[i] - dat->y[j];
/*
    int rd;
...
static int geographic_edgelen (int i, int j, compass_data *dat)
{
    double deg, min;
...
static int geom_edgelen (int i, int j, compass_data *dat)
{
    double lati, latj, longi, longj;
...
static int att_edgelen (int i, int j, compass_data *dat)
{
...
static int dsjrand_edgelen (int i, int j, compass_data *dat)
{
    int di = (int) dat->x[i];
    int dj = (int) dat->x[j];
    int x, y, z;
...
static int crystal_edgelen (int i, int j, compass_data *dat)
{
    double w, w1;
...
static int matrix_edgelen (int i, int j, compass_data *dat)
{
    if (i > j)
        return (dat->adj[i])[j];
    else
...
static int sparse_edgelen (int i, int j, compass_data *dat)
{
    int *adj;
    int k, deg;
...
static int user_edgelen (int i, int j, compass_data *dat)
{
...
static int rhmap1_edgelen (int i, int j, compass_data *dat)
{
...
static int rhmap2_edgelen (int i, int j, compass_data *dat)
{
    char **vectors = dat->rhdat.vectors;
    int rhlength = dat->rhdat.rhlength;
    char *v1 = vectors[i];
...
static int rhmap3_edgelen (int i, int j, compass_data *dat)
{
    char **vectors = dat->rhdat.vectors;
...
static int rhmap4_edgelen (int i, int j, compass_data *dat)
{
    char **vectors = dat->rhdat.vectors;
    int len = dat->rhdat.rhlength;
    char *first = vectors[i];
...
static int rhmap5_edgelen (int i, int j, compass_data *dat)
{
    char **vectors = dat->rhdat.vectors;
    int rhlength = dat->rhdat.rhlength;
    char *v1 = vectors[i];
