...
int
    CCkdtree_build (CCkdtree *kt, int ncount, compass_data *dat,
        double *wcoord, CCrandstate *rstate),
    CCkdtree_k_nearest (CCkdtree *kt, int ncount, int k, compass_data *dat,
    ...
    CCkdtree_node_quadrant_k_nearest (CCkdtree *kt, int ncount, int n, int k,
        compass_data *dat, double *wcoord, int *list, CCrandstate *rstate),
    CCkdtree_node_nearest (CCkdtree *kt, int n, compass_data *dat,
        double *wcoord),
    CCkdtree_fixed_radius_nearest (CCkdtree *kt, compass_data *dat,
    ...
    CCkdtree_prim_spanningtree (CCkdtree *kt, int ncount, compass_data *dat,
        double *wcoord, int *outtree, double *val, CCrandstate *rstate),
    CCkdtree_greedy_tour (CCkdtree *kt, int ncount, compass_data *dat,
        int *outcycle, double *val, int silent, CCrandstate *rstate),
    CCkdtree_far_add_tour (CCkdtree *kt, int ncount, int start,
        compass_data *dat, int *outcycle, double *val, CCrandstate *rstate),
    CCkdtree_qboruvka_tour (CCkdtree *kt, int ncount, compass_data *dat,
        int *outcycle, double *val, CCrandstate *rstate),
    CCkdtree_boruvka_tour (CCkdtree *kt, int ncount, compass_data *dat,
        int *outcycle, double *val, CCrandstate *rstate),
    CCkdtree_twoopt_tour (CCkdtree *kt, int ncount, compass_data *dat,
        int *incycle, int *outcycle, double *val, int run_two_and_a_half_opt,
        int silent, CCrandstate *rstate),
    CCkdtree_3opt_tour (CCkdtree *kt, int ncount, compass_data *dat,
