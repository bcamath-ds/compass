...
/*    EXPORTED FUNCTIONS:                                                   */
/*                                                                          */
/*  int CCkdtree_twoopt_tour (CCkdtree *kt, int ncount, compass_data *dat,   */
...
/*                                                                          */
/*  int CCkdtree_3opt_tour (CCkdtree *kt, int ncount, compass_data *dat,     */
...
static int
    run_two_opt (int ncount, int silent, int *tour,
          ...
          compass_data *dat, optqueue *activequeue),
    run_3_opt (int ncount, int silent, int *tour, int *neighbor,
           CCkdtree *thetree, compass_data *dat, optqueue *activequeue),
    ...
    three_swap_from_node (int a, int *neighbor, CCkdtree *thetree,
           compass_data *dat, optqueue *activequeue, flipper *f),
...
static double
    cycle_length (int *cyc, int ncount, compass_data *dat);
...
static int run_3_opt (int ncount, int silent, int *tour,
                      int *neighbor, CCkdtree *thetree, compass_data *dat,
                      optqueue *activequeue)
{
    int i, hit;
    int start;
...
static int try_two_swap (int a, int c, void *pass_param)
{
    ...
    compass_data *dat = ((twoopt_param *) pass_param)->dat;
...
static double cycle_length (int *cyc, int ncount, compass_data *dat)
{
    int i;
    double len;
